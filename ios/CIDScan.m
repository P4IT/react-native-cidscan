...
RCT_EXPORT_METHOD(decoderTimeLimintInMilliseconds:(nonnull NSNumber *)timeLimit) {
...
RCT_EXPORT_METHOD(setCameraZoom:(BOOL)value zoomValue:(nonnull NSNumber *)zoom) {
...
RCT_EXPORT_METHOD(setExposureSensitivity:(NSString *)iso) {
  char isoChar = (char)[iso UTF8String];
...
RCT_EXPORT_METHOD(enableBarcode:(NSString *)symbologyName enable:(BOOL)enable) {
